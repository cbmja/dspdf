...
public class Master {
    ...
    private Integer TOTAL_SEND_CNT; //총 건수 : 대량일 경우 TOTAL_SEND_CNT , 단일건일 경우 전일 14:00이상 ~ 금일 14:00미만 전송 건수
    @JsonProperty("SEND_CNT")
    private Integer SEND_CNT; //현재 전송 건수
    @JsonProperty("STATUS")
    private Integer STATUS; //상태 : 대기중 , 출력중 , 발송중 등등
